            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
                ...
                <div class="i_con">
                    <ul class="nav navbar-nav text-uppercase">
                        ...
                        <?php else: ?>
                            <li class="popover-style">
                                <button class="btn btn-lg btn-link popover-body"
                                        data-container="body"
                                        data-toggle="popover"
                                        data-trigger="focus"
                                        data-placement="bottom"
                                        data-title="
                                        <a href='<?= Url::to(['/site/profile']) ?>' data-method='post'>Профиль</a>"
                                        data-content="
                                        <a href='<?= Url::to(['/auth/logout']) ?>' data-method='post'>Выход</a>">
                                    <i class="glyphicon glyphicon-user"></i><strong><?= Yii::$app->user->identity->name ?></strong>
                                </button>
                            </li>
                        <?php endif;?>
                    </ul>
...
<footer class="footer-widget-section">
    ...
    <div class="footer-copy">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <div class="text-center">&copy; <?= date('Y') ?> <a href="#">Yii-site, </a> Built with <i
                                class="fa fa-heart"></i> by <a href="#">Panchenko Vlad</a>
                    </div>
                </div>
            </div>
        </div>
